    ...
    <div class="card-body">
      <div class="border-bottom pb-2 card-title">
        ...
        <div class="small text-muted">
          Basado en la opinion de los clientes
        </div>
      </div>
      <div>
            ...
            <tr v-for="(product, index) in products" :key="product.id">
              ...
              <td class="text-right">
                <div class="d-inline-block" v-if="product.rating > 0">
                  <star-rating :rating="product.rating" :read-only="true" :show-rating="false" star-size="20"  />
                </div>
                <div v-else>
                  Sin votos
                </div>
              ...
              <td>
                <template v-if="product.rating > 0">
                  ...
                  <span class="badge badge-warning" v-else-if="product.rating >= 2">{{product.rating}}</span>

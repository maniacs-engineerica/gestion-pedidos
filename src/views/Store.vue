        ...
        <div class="col-6 col-md-2">
            ...
            <div id="filtersContainer">
                ...
                <div>
                    ...
                    <label for="price-min" class="badge badge-light" style="font-size: 15px">Precio Mínimo: <span class="badge badge-secondary" style="font-size: 13px">{{minPrice}}</span> </label>
                    <br>
                     <input type="range" name="price-min" id="price-min" value="0" min="0" max="1000" v-model="minPrice">
                   <br>
                    <label for="price-max" class="badge badge-light" style="font-size: 15px">Precio Máximo: <span class="badge badge-secondary" style="font-size: 13px">{{maxPrice}}</span>  </label>
                    <br>
                    <input type="range" name="price-max" id="price-max" value="0" min="0" max="1000" v-model="maxPrice">
                    </div>
                    <br>                
                </div>
                    <div>
      ...
      filter () {          
           let a = []           
               ...
               a = this.filterProducts.filter((item) => {
                   ...
                   const cumpleLocation = !this.productLocation || item.location == this.productLocation
                   const cumpleMinPrice = !this.minPrice || item.price >= this.minPrice
                   const cumpleMaxPrice = !this.maxPrice || item.price <= this.maxPrice
                   return cumpleRating && cumpleBusqueda && cumpleLocation && cumpleMinPrice && cumpleMaxPrice
                   }
                   )
